...
export ENGINE_CERTS_DIR=certs/engine
export COMMANDER_CERTS_DIR=certs/commander
export COMMANDER_MASTER_CERTS_DIR=certs/commander/master
export TESTRUNNER_CERTS_DIR=certs/tests
export EMULATEDHOST_CERTS_DIR=certs/emulatedhost

export REGISTRY_HOSTNAME=coregistry
export REGISTRY_AUTH_DIR=certs/registry/auth
export REGISTRY_CERTS_DIR=certs/registry
